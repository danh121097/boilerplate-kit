...
Scaffold an opinionated frontend starter in seconds. One CLI, five curated stacks:
...
> Status: alpha — phase 01 scaffolding only. CLI surface, template fetch, and the five starters land in subsequent phases.

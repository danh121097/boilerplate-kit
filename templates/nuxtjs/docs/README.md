...
Agent-ready documentation for this template — how THIS codebase is built
(stack-specific).
...
| [design-guidelines.md](./design-guidelines.md) | Tailwind v4, Reka UI components, theming, a11y |

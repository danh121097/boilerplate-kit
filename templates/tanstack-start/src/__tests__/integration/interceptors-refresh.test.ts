 ...
 *
 * These tests are identical to the reactjs template — the interceptor logic and
 * SSR guards are the same; SSR-specific storage tests live in auth-token-storage.test.ts.
 */
